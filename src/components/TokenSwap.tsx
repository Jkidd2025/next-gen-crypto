...
export const TokenSwap = () => {
  ...
  return (
    <div className="min-h-screen bg-background py-4 md:py-8" id="swap">
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="w-full max-w-xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-4 md:p-6 border border-primary/10">
              {!isWalletConnected ? (
